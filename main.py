...
class AlienInvasion:
  ...
  def _update_bullets(self):
    ...
    #Remove any buleets and aliens that have collided.
    
  def _check_bullet_alien_collisions(self):
    collisions = pygame.sprite.groupcollide(self.bullets, self.aliens, True, True)
    if collisions:
      for aliens in collisions.values():
        self.stats.score += self.settingd.alien_points * len(aliens)
      self.sb.prep_score()
  ...
  def _update_aliens(self):
    """Check if the fleet is at an edge, then update the positions of all alien in the fleet."""
